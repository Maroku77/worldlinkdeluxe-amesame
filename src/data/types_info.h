...
{//                   Defender -->
 //  Attacker           None  Illusion Dream   Flying  Miasma  Earth   Beast   Heart   Ghost   Steel   Mystery  Fire   Water   Nature  Wind    Reason    Ice   Faith   Dark    Cosmic  Stellar
    ...
    [TYPE_SOUND] = {______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.0), ______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______},
    ...
    [TYPE_LIGHT]   = {______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, X(2.0), ______, ______, X(2.0), ______, X(0.5), ______, X(0.5), ______, ______},
